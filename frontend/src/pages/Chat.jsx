...
const Chat = () => {
  ...
  // Otomatik Tartışma Modu'na özel: true ise her sağlayıcıya sabit bir rol atanır
  // (Pratik Uygulayıcı / Eleştirmen / Sentezleyici-Tur Rehberi) - bkz. ChatService#DEBATE_ROLE_HINTS.
  const [useDebateRoles, setUseDebateRoles] = useState(false);
      ...
      <div className="main-content">
        <div className="input-section">
          ...
          <div className="input-toolbar-row">
            ...
            {mode === CHAT_MODES.COMPARE && (
              <label className="debate-roles-toggle" title="Etkinleştirirsen her modele sabit bir tartışma rolü atanır: Pratik Uygulayıcı, Eleştirmen/Şeytanın Avukatı ve Sentezleyici/Tur Rehberi.">
                <input
                  type="checkbox"
                  checked={useDebateRoles}
                  onChange={(e) => setUseDebateRoles(e.target.checked)}
                />
                Rollere göre tartıştır (Uygulayıcı / Eleştirmen / Tur Rehberi)
              </label>
            )}
          </div>
